...
> **Sample solution (after trying yourself):** [Iteration 1 – POST](./job-app/frontend/step1/src/pages/AddJobPage.jsx)
...
> **Sample solution (after trying yourself):** [Iteration 2 – GET all](./job-app/frontend/step2/)
...
> **Sample solution (after trying yourself):** [Iteration 3 – GET one](./job-app/frontend/step3/)
...
> **Sample solution (after trying yourself):** [Iteration 4 – DELETE](./job-app/frontend/step4/)
...
> **Sample solution (after trying yourself):** [Iteration 5 – PUT](./job-app/frontend/step5/)
...
<!-- 
```sh
npm i express mongoose morgan dotenv cors  bcryptjs jsonwebtoken validator cross-env colors
